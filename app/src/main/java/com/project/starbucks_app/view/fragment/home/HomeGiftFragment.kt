...
import com.project.starbucks_app.databinding.FragmentHomeGiftBinding
import com.project.starbucks_app.view.base.BaseFragment
import com.project.starbucks_app.view.vm.MenuViewModel

class HomeGiftFragment : BaseFragment<MenuViewModel, FragmentHomeGiftBinding>() {

    companion object {
        @JvmStatic
        fun newInstance() = HomeGiftFragment()
    }

    override fun getViewModel(): Class<MenuViewModel> = MenuViewModel::class.java

    override fun getLayoutRes(): Int = R.layout.fragment_home_gift
